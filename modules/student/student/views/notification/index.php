...
<div class="mA10 clearfix">
	...
	?>
	<span class="error"><?php echo Yii::t('lang','Bạn có');?> <b id="countNotConfirmed"><?php echo $countNotConfirmed;?></b> <?php echo Yii::t('lang','thông báo từ hệ thống speakup.vn được đánh dấu là chưa đọc! Vui lòng xem thông báo và xác nhận đã đọc');?>!</span>
	<?php endif;?>
</div>
