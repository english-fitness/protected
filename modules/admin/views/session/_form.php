...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div id="displayWhiteboard" class="form-element-container row">
		...
		<div class="col col-lg-9" id="whiteboard<?php echo $model->id;?>">
			<?php if($model->whiteboard):?>
				...
				<?php endif;?>
			<?php else:?>
				<a href="javascript: createBoard('<?php echo $model->id;?>', 0, 1, 0, 2);">Lớp P2P</a> hoặc
				<a href="javascript: createBoard('<?php echo $model->id;?>', 0, 0, 0, 2);">Lớp thường</a> hoặc
				...
				<a href="javascript: createBoard('<?php echo $model->id;?>', 0, 0, 0, 1);">Lớp hạn chế</a> 
				<!--hoặc
	...
	<div class="form-element-container row">
		...
		<div class="col col-lg-9">
            <?php $this->renderPartial("/widgets/addUser",array("userRole"=>"student")); ?>
