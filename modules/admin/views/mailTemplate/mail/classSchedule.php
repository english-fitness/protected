<div style="font-size:12.8px">
	<div dir="ltr">
		...
		<div>
			...
			<div>
				<p>
					Chúng tôi xin thông báo các thông tin về khóa học chính thức của bạn như sau:<br>
				</p>
				<table style="border-top:dashed 1px black;border-bottom:dashed 1px black; border-spacing:0 10px; border-collapse:separate; margin-bottom:10px">
					...
					<tr>
						<td>Ngày học trong tuần</td>
						<td>&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<span class="mail-attr" data-attribute="wday"><?php echo isset($wday) ? $wday : "..."?></span></td>
					</tr>
					<tr>
						<td>Thời gian</td>
