<div class="rendered-form">
	<label>Tiêu đề</label>
	<input type="text" id="mail-subject" name="Mail[subject]" class="mB10" readonly>
	...
	<label>Ngày học&nbsp;</label><span id="date-notice" class="errorMessage"></span>
...
<script type="text/javascript">
	$('#mail-form').submit(function(e){
    	...
    	if (!data['Mail[template]'] || !data['Mail[email]'] || !data['Mail[password]'] || !data['Mail[name]'] || !data['Mail[date]'] || !data['Mail[time]']){
    		if (!data['Mail[name]']){
    ...
    $(document).ready(function(){
    	$('.datepicker').change(function(){
    		$('#mail-subject').val("Thông báo lịch học cùng Speakup.vn ngày " + this.value);
    	});
    })
</script>