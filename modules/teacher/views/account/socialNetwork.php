...
<div class="form">
    <div class="account">
        ...
        <?php $form=$this->beginWidget('CActiveForm',array(
            ...
            "action"=>"/teacher/account/socialNetwork"
        )); ?>
        <div class="row-form">
        ...
        <div class="row-form">
            ...
            <div class="value col-sm-7">
				...
				<div class="btn-facebook-connect" onclick="javascript:oauthConnectPopup('<?php echo Yii::app()->baseUrl."/teacher/account/connectFacebook";?>', 760, 480)">Kết nối với Facebook</div>
				<?php endif;?>
            </div>
        </div>
        <div class="row-form">
            ...
            <div class="value col-sm-7">
				...
				<?php else:?>
				<p>Trạng thái: <b class="error">Chưa kết nối!</b></p>
				<div class="btn-google-connect" onclick="javascript:oauthConnectPopup('<?php echo Yii::app()->baseUrl."/teacher/account/connectGoogle";?>', 760, 480)">Kết nối với Gmail</div>
				<?php endif;?>
            </div>
        </div>
        <div class="row-form">
            ...
            <div class="value col-sm-7">
				...
				<?php else:?>
				<p>Trạng thái: <b class="error">Chưa kết nối!</b></p>
				<div class="btn-hocmai-connect" onclick="javascript:oauthConnectPopup('<?php echo Yii::app()->baseUrl."/teacher/account/connectHocmai";?>', 580, 320)">Kết nối với Hocmai.vn</div>
				<?php endif;?>
            </div>
        </div>
        <?php $this->endWidget(); ?>
