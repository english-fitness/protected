...
class SessionMonitorNote extends CActiveRecord
{
	/**
	...
	{
		return 'tbl_session_monitor_note';
	}
	...
	public function rules()
	{
		...
		return array(
			array('using_platform, note', 'required'),
	 ...
	 * @return SessionMonitorNote the static model class
	 */
