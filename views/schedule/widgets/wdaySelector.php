...
<div class="wday-selector">
    ...
    <button class='wday-select btn' day='0'>Monday<br></button>
    <button class='wday-select btn' day='1'>Tuesday<br></button>
    <button class='wday-select btn' day='2'>Wednesday<br></button>
    <button class='wday-select btn' day='3'>Thursday<br></button>
    <button class='wday-select btn' day='4'>Friday<br></button>
    <button class='wday-select btn' day='5'>Saturday<br></button>
    <button class='wday-select btn' day='6'>Sunday<br></button>
    <button class='week-nav btn btn-primary' nav='next'>></button>
</div>
<div class="date-navigator">
    <button id="today-select" class='btn' style="margin-right:5px; outline:none">Today (<?php echo date('d-m-Y')?>)</button>
