...
<div id="main">
    ...
    <div id="main-banner">
        <div id="body-header" class="clearfix">
            ...
            <div id="quick-nav">
                <a href="#" class="quick-nav-link teleporter accent" data-waypoint="content-start">Tiếng Anh 1-1</a>
                <a href="#" class="quick-nav-link teleporter accent" data-waypoint="more-detail">Giáo viên</a>
    ...
    <div id="content">
        ...
        <div id="introduction" class="body-content">
            ...
            <div class="text-center" style="padding-top:50px">
                <a href="#" class="orange-btn large teleporter" data-waypoint="more-detail">CHỌN NGAY GIÁO VIÊN CHO MÌNH</a>
            </div>
        </div>
        <!--end introduction-->
        <!--teachers-->
        <div id="more-detail" class="body-content">
            <h2 id="teacher-title">
        ...
        <!--end teachers-->
        <!--register-->
        <div id="register" class="body-content">
            <div class="content-title register-title">
                <p>CHỈ <span style="font-size:65px; color:#fa5a00">3</span> BƯỚC ĐỂ SPEAK UP NGAY</p>
            </div>
            <div class="frame accent-bg" style="width:1020px">
                <div id="steps-container" class="clearfix">
                    <div class="twoside piece clearfix">
                    ...
                    <div class="leftside piece clearfix">
