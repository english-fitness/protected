...
--
-- Host: localhost    Database: daykem2
-- ------------------------------------------------------
...
--
-- Table structure for table `tbl_course_attendee`
--

DROP TABLE IF EXISTS `tbl_course_attendee`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_course_attendee` (
  `course_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`course_id`,`user_id`),
  KEY `fk_course_attendee_course` (`course_id`),
  KEY `fk_course_attendee_user` (`user_id`),
  ...
  CONSTRAINT `fk_course_attendee_user` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_course_attendee`
--

LOCK TABLES `tbl_course_attendee` WRITE;
/*!40000 ALTER TABLE `tbl_course_attendee` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_course_attendee` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `tbl_session_attendee`
--

DROP TABLE IF EXISTS `tbl_session_attendee`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_session_attendee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_session_attendee_user` (`user_id`),
  KEY `fk_session_attendee_session` (`session_id`),
  CONSTRAINT `fk_session_attendee_user` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_session_attendee_session` FOREIGN KEY (`session_id`) REFERENCES `tbl_session` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_session_attendee`
--

LOCK TABLES `tbl_session_attendee` WRITE;
/*!40000 ALTER TABLE `tbl_session_attendee` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_session_attendee` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tbl_teacher_ability` (
  ...
  KEY `fk_teacher_ability_user` (`user_id`),
  KEY `fk_teacher_ability_subject` (`subject_id`),
  CONSTRAINT `fk_teacher_ability_user` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `tbl_user` VALUES (1,'admin@daykem11.com','$5$9VgnmUf4AGbXjHDP$n6FM0J9qi86b.11anaFmuWB4MApgD8OKPxe51bnzT.7','Online','Tutor','2013-11-15',0,'Ha Noi','0987654321',NULL,'Administrator','role_admin','2013-11-15 09:57:07','2013-11-20 15:53:06',0,NULL,NULL);
...
-- Dump completed on 2013-11-20 15:53:58
