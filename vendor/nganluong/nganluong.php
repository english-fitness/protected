...
class NL_Checkout 
{
	...
	//Add function contruct ngan luong
	public function __construct($nganluongUrl=NULL, $merchantSiteCode=NULL, $securePass=NULL)
	{
		if($nganluongUrl!=NULL && $merchantSiteCode!=NULL && $securePass!=NULL)
		{
			$this->nganluong_url = $nganluongUrl;//Set ngan luong url
			$this->merchant_site_code = $merchantSiteCode;//Set merchant_site_code
			$this->secure_pass = $securePass;//Set secure_pass
		}
	}
