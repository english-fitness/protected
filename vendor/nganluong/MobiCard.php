  ...
  class MobiCard
  {
	   ...
	   function CardPay($pin_card,$card_serial,$type_card,$_order_id,$client_fullname,$client_mobile,$client_email) 
	   {
			 $params = array(
					...
					'merchant_account'		=> $this->receiver_email,
		...
		function CardPayWebservice($pin_card,$card_serial,$type_card,$ref_code,$client_fullname,$client_mobile,$client_email) 
			{
				 ...
				 $strparams = $pin_card.'|'. $type_card .'|'. $ref_code .'|'. $this->receiver_email .'|'. $client_fullname .'|'. $client_email .'|'. $client_mobile .'|'.$card_serial ;
							
				 $params = array(						
						'merchant_id'			=> $this->merchant_id,						
						'checksum'		=> MD5($strparams .'|'.$this->merchant_password),
						'params'		=> $strparams
					);
